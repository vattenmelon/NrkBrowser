...
namespace Vattenmelon.Nrk.Browser
{
    public class NrkPlugin : GUIWindow, ISetupForm
    {
        ...
        protected void Activate(Item item)
        {
            ...
            {
                UpdateList((List<PodKast>)nrkParser.GetLydPodkaster());
            }
            else if (item.ID == NrkBrowserConstants.MENU_ITEM_ID_PODCASTS_VIDEO)
            {
                UpdateList((List<PodKast>)nrkParser.GetVideoPodkaster());
            }
        ...
        private List<Item> CreatePodcastMenuItems()
        {
            ...
            items.Add(new MenuItem(NrkBrowserConstants.MENU_ITEM_ID_PODCASTS_AUDIO, NrkTranslatableStrings.MENU_ITEM_TITLE_PODCASTS_AUDIO));
            items.Add(new MenuItem(NrkBrowserConstants.MENU_ITEM_ID_PODCASTS_VIDEO, NrkTranslatableStrings.MENU_ITEM_TITLE_PODCASTS_VIDEO));
            return items;
        }
