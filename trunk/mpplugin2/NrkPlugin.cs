...
namespace Vattenmelon.Nrk.Browser
{
    public class NrkPlugin : GUIWindow, ISetupForm
    {
        ...
        public override void Process()
        {
            ...
            if (selecteditem.ID == NrkBrowserConstants.MENU_ITEM_ID_ALPHABETICAL_LIST || selecteditem.ID == NrkBrowserConstants.MENU_ITEM_ID_CATEGORIES || selecteditem.ID == NrkBrowserConstants.MENU_ITEM_ID_LATEST_CLIPS ||
        ...
        protected void Activate(Item item)
        {
            ...
            else if (item.ID == NrkBrowserConstants.MENU_ITEM_ID_LATEST_CLIPS)
            {
                UpdateList(nrkParser.GetSistePaaForsiden());
                setClipCount(nrkParser.GetSistePaaForsiden());
            }
...
//            }
        ...
        private List<Item> CreateInitialMenuItems()
        {
            ...
            MenuItem sisteKlipp = new MenuItem(NrkBrowserConstants.MENU_ITEM_ID_LATEST_CLIPS, NrkTranslatableStrings.MENU_ITEM_TITLE_LATEST_CLIPS);
